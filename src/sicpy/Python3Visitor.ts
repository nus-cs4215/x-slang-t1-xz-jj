...
export interface Python3Visitor<Result> extends ParseTreeVisitor<Result> {
	 ...
	 * @return the visitor result
	 */
	visitNamedexpr_test?: (ctx: Namedexpr_testContext) => Result;
	...
	/**
	 * Visit a parse tree produced by `Python3Parser.func_body_suite`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitFunc_body_suite?: (ctx: Func_body_suiteContext) => Result;

	/**
	 * Visit a parse tree produced by `Python3Parser.func_type_input`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitFunc_type_input?: (ctx: Func_type_inputContext) => Result;

	/**
	 * Visit a parse tree produced by `Python3Parser.func_type`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by `Python3Parser.typelist`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */

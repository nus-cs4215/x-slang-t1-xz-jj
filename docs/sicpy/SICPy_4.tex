...
% &&                       && |   &\quad &&   \textit{dictionary-expression} && \textrm{dictionary expression} \\
...
% && \textit{dictionary-expression}   && ::= &\quad &&   
%                                             \textbf{\texttt{\{}} \ \textit{expression} \ \textbf{\texttt{:}} \ \textit{expression} \  [\ \textbf{\texttt{,}} \ \textit{expression} \ \textbf{\texttt{:}} \ \textit{expression} \ ]\ \ldots \ \textbf{\texttt{\}}}
%                                             && \textrm{literal dict expression}\\[1mm]      
&& \textit{tuple-expression}   && ::= &\quad &&  \epsilon \ | \ \textit{expression} \ \textbf{\texttt{,}} \ \textit{expressions}  && \textit{tuple expression}  \\[1mm]
% &&                       && |   &\quad && \textit{expression} \ \textbf{\texttt{,}} \ \textit{expressions} &&  \\ [1mm]
